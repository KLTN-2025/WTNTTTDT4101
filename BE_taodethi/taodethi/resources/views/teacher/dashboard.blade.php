	...
	<div class="py-8">
		<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				<a href="{{ route('teacher.questions.index') }}" class="block bg-white border border-gray-200 rounded-xl p-6 hover:shadow-sm transition">
				...
				<a href="{{ route('teacher.exams.index') }}" class="block bg-white border border-gray-200 rounded-xl p-6 hover:shadow-sm transition">
				...
				<a href="{{ route('teacher.grading.index') }}" class="block bg-white border border-gray-200 rounded-xl p-6 hover:shadow-sm transition">
				...
				<a href="{{ route('teacher.schedules.index') }}" class="block bg-white border border-gray-200 rounded-xl p-6 hover:shadow-sm transition">
				...
				<a href="{{ route('teacher.classes.index') }}" class="block bg-white border border-gray-200 rounded-xl p-6 hover:shadow-sm transition">
